...
import '../screen/coin/screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => CoinScreen(coin)),
        );
      },
      child: Padding(
              ...
              child: FittedBox(
                ...
                child: Center(
                    child: Text(PriceFormatter.formatPrice(
                        coin.price, selectedReferenceCurrency.getSignSymbol(), true))),
              )),
          SizedBox(
              ...
              child: FittedBox(
                  ...
                  child: Center(
                      child: Text(PriceFormatter.formatPrice(coin.marketCap,
                          selectedReferenceCurrency.getSignSymbol(), false))))),
        ]),
      ),
    );
  }
